  ...
  return (
    <section
      ...
      className="relative w-full h-screen min-h-[800px] md:h-[1080px] bg-black overflow-hidden flex flex-col justify-end px-6 md:px-16 pb-16 md:pb-24">
        ...
        className="absolute left-1/2 top-1/3 -translate-x-1/2 -translate-y-1/2 w-full max-w-[500px] aspect-square z-20 pointer-events-none">
          ...
          className="flex flex-col gap-4">
              ...
              <h1 className="hero-title text-white tracking-[-0.05em] uppercase m-0 leading-[0.85] !w-full !h-full">
